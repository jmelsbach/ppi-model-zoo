...
model = LSTMAWD(num_codes=250, embedding_size=64, steps_per_epoch=None, num_epochs=10, lstm_dropout_rate=0.3, # todo: rename num_codes? (num_codes is the vocab_size of the tokenizer); do we num_epochs?
                ...
                lr_scaling=False, trunc_len=1500, embedding_droprate=0.3, frozen_epochs=0, optimizer_type='ranger21')
