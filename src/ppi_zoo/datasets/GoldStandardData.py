...
class GoldStandardDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        if train_size == 1.0 and val_size == 0.0:
            ...
            train_indices, val_indices = train_test_split(all_train_indices, train_size=train_size, test_size=val_size, shuffle=True)
    ...
    def test_dataloader(self):
        return [
            DataLoader(self.test1_dataset, batch_size=self.batch_size, shuffle=False, num_workers=self.num_workers),
            DataLoader(self.test2_dataset, batch_size=self.batch_size, shuffle=False, num_workers=self.num_workers),
        ]